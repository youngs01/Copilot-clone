...
// this is end of background gradient


if (window.innerWidth <= 1200) {

    var linenavtabs = document.querySelector('.line-nav-tabs')
    linenavtabs.style.width = '172px';
  }

  if (window.innerWidth <= 520) {

    var heroheading = document.querySelector('.hero-heading');
    heroheading.style.fontSize = '30px';
    heroheading.style.fontWeight = '600';
    heroheading.style.lineHeight = '35px';


    var neighbourheading = document.querySelector('.neighbour-heading');
    neighbourheading.style.fontSize = '32px';
    neighbourheading.style.paddingBottom = '10px';
    neighbourheading.style.fontWeight = '600';


    var copilotAppHeading = document.querySelector('.copilot-apps-heading');
    copilotAppHeading.style.fontSize = '30px';
    copilotAppHeading.style.paddingBottom = '10px';
    copilotAppHeading.style.fontWeight = '600';


    var automationHeading = document.querySelector('.automation-heading');
    automationHeading.style.fontSize = '30px';
    automationHeading.style.fontWeight = '600';
  ...
  var mySwiper = new Swiper(".mySwiper", {
    ...
    slidesPerView: "auto",
    freeMode: true,
    freeModeMomentum: false, // Disable momentum for a smoother experience
    freeModeMomentumBounce: false, // Disable momentum bounce
    freeModeSticky: true,
    speed: 2000, // Adjust the speed as needed
    loop: true,
    grabCursor: true,
    autoplay: {
      delay: 0, // Set the autoplay delay to 5 seconds (adjust as needed).
